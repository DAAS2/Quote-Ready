...
/* ────────────────────────────────────────────────────────────────────────────
 * Landing page — transcribed 1:1 from the B2B SaaS landing design.
 * CTAs are wired to the live demo workspace (/dashboard) and auth.
 * ──────────────────────────────────────────────────────────────────────────── */
      ...
      <main className="w-full pt-16 bg-surface">
        ...
        <section className="relative w-full overflow-hidden pt-8 pb-16 md:pt-12 md:pb-24">
          ...
          <div className="absolute inset-0 pointer-events-none -z-10 flex justify-center">
            <div className="w-[1100px] h-[500px] rounded-full bg-surface-container/60 blur-3xl opacity-70 -translate-y-1/3"></div>
            <div className="w-[600px] h-[300px] rounded-full bg-primary-fixed/20 blur-2xl opacity-40 translate-x-1/3 -translate-y-1/4"></div>
          </div>
          <div className="max-w-7xl mx-auto px-margin flex flex-col items-center text-center">
            {/* Eyebrow Pill */}
            <div className="inline-flex items-center gap-space-xs px-space-md py-1 rounded-full bg-surface-container-high text-primary font-label-md text-label-md mb-6 shadow-sm">
            ...
            {/* Main Headline */}
            <h1 className="font-headline-lg md:font-display-lg text-headline-lg md:text-display-lg text-on-surface max-w-4xl tracking-tight leading-tight mb-5">
              Know what you need <br className="hidden sm:inline" />
              <span className="text-primary-container">before you quote.</span>
            </h1>
            {/* Supporting Copy */}
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mb-8 text-balance">
            ...
            {/* CTAs */}
            <div className="flex flex-col sm:flex-row items-center gap-space-md mb-6">
              <Link
                className="inline-flex items-center justify-center h-11 px-6 rounded-lg bg-primary-container text-on-primary font-label-lg text-label-lg hover:bg-primary transition-all shadow-[0_2px_8px_rgba(15,118,110,0.25)] group"
                href="/dashboard"
              >
            ...
            <div className="inline-flex items-center gap-space-xs text-on-surface-variant font-label-sm text-label-sm bg-surface-container-low/70 px-4 py-1.5 rounded-full">
              <span className="material-symbols-outlined text-[16px] text-primary">security</span>
              <span>
                Built for human review. No automatic pricing. No automatic customer messages.
              </span>
            </div>
            {/* Hero Visual Mockup: QuoteReady Job Detail Interface */}
              ...
              <div className="rounded-xl overflow-hidden bg-surface-container-lowest shadow-[0_12px_36px_rgba(16,42,67,0.09)] transition-all">
                ...
                <div className="p-4 sm:p-6 bg-surface-container-lowest flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {/* Amber Status Badge */}
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#FEF3C7] text-[#92400E]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 bg-surface-container-low/40">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="font-label-md text-label-md text-on-surface font-semibold uppercase tracking-wider flex items-center gap-1.5">
                          ...
                          Missing information (3 Pending flags)
                        </h3>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#FEF3C7]/40">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-body-sm text-body-sm text-on-surface-variant mt-0.5">
                              Cannot determine if 35mm / 40mm European disc or complete mixer
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-surface-container-lowest">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-body-sm text-body-sm text-on-surface-variant mt-0.5">
                              Mini-stops visible but calcification grade unknown. Main meter shutoff
                              may be required.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#FEE2E2]/50">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-body-sm text-body-sm text-on-surface-variant mt-0.5">
                              Photo 2 hints at timber swelling beneath S-trap collar. Risk of
                  ...
                  <div className="lg:col-span-5 p-4 sm:p-6 bg-surface-container-lowest flex flex-col justify-between">
                    <div>
                      ...
                      <div className="bg-surface-container-low rounded-xl p-4 mb-4 font-body-md text-body-md text-on-surface leading-relaxed relative">
                        <div className="absolute -top-2 left-6 w-3 h-3 bg-surface-container-low rotate-45"></div>
                        <p className="mb-3">“Hi Jordan, thanks for sending through photos of your bathroom tap.</p>
                        <p className="mb-3">
                          To help us confirm the exact repair approach and parts, could you please
                          send a quick photo of the underside plumbing showing whether the mini-stop
                          valves turn smoothly?
                        </p>
                        <p>
                          Based on current details, an on-site diagnostic inspection ($89 refundable
                          against work) is strongly recommended before fixing a price, so we
                          don&apos;t encounter unforeseen variations.”
                        </p>
                      </div>
              ...
              <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm flex flex-col justify-between transition-transform hover:-translate-y-1 duration-200">
                <div>
                  ...
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    Drop customer text from WhatsApp, SMS, or website intake forms. Upload
                    homeowner photos of leaks, meters, or cabinetry.
                  </p>
                </div>
